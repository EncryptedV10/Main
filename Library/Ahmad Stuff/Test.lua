loadstring(game:HttpGet("https://raw.githubusercontent.com/EncryptedV10/Main/refs/heads/main/Library/Ahmad%20Stuff/Settings.lua"))()
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/EncryptedV10/Main/refs/heads/main/Library/Ahmad%20Stuff/V3%20Library.lua"))()
local Window = Library:MakeWindow({
    Title = "Nova Hub | " .. Version,
    SaveFolder = "Speed Hub X"
});Window:AddMinimizeButton({
    Button = {Image = "rbxassetid://72433868262469"},
    Corner = {CornerRadius = UDim.new(0, 5)}
})
local Home = Window:MakeTab({"Home", "scan-face"})
Home:AddDiscordInvite({
    Name = "Nova Hub!",
    Logo = "rbxassetid://72433868262469",
    Invite = Discord
})
